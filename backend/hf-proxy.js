...
// Basic check to ensure the key is loaded and not a placeholder
if (!GEMINI_API_KEY || GEMINI_API_KEY === 'PLACEHOLDER_INSERT_YOUR_KEY_HERE') {
    console.error("\n❌ FATAL ERROR: GEMINI_API_KEY is missing or is still a placeholder.");
    console.error("👉 Please open the '.env' file in the 'backend' folder and replace the placeholder with your actual key.");
    console.error("🌐 You can get a free API key here: https://aistudio.google.com/app/apikey\n");
    process.exit(1);
}
